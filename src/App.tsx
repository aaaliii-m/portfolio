  ...
  return (
    ...
    <div className='bg-background min-h-screen grid-background relative'>
      <div className="flex w-full h-[45px] bg-green-700/20 absolute top-0 left-0 z-0 justify-center">
        <img src={freePalestine} alt="Free Palestine" title='free palestine' className='w-[180px] h-auto object-fit' />
      </div>
        ...
        <div id="top">
          ...
          <div className='mt-12 pt-12 pb-6 sm:pb-8 flex justify-center items-center px-4'>
           ...
           after:font-bold after:text-neutral-300 after:bg-background after:px-[4px] after:z-10">
                <p className='text-white p-4 md:p-6 text-sm md:text-lg leading-relaxed'>Man is primarily governed by passion and instinct.</p>
              </blockquote>
              <div className='flex justify-end w-full'>
              <figcaption className='p-2 md:p-3 w-fit text-white text-sm md:text-lg text-right relative z-20 border-t-0 border border-gray-500'>— Muhammad Iqbal</figcaption>
              </div>
            </div>
          </div>
          {/* Projects Section */}
